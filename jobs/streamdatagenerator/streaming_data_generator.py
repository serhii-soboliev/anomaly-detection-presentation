...
def run_generation(args, pipeline_args):
    ...
    logging.info("Parameters: start={}, stop={}, elements per second = {}, output topic = {}"
                 .format(start_, stop_, element_per_period_, output_topic))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-topic',
                        type=str,
                        required=True,
                        help='Name of Pub/Sub topic where to stream generated events')

    known_args, pipeline_args = parser.parse_known_args()

    run_generation(known_args, pipeline_args)
